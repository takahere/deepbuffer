...
import { Inbox, Bookmark, Settings, Coffee, Zap, LogOut } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, isLocked, onToggleLock }) => {
  ...
  return (
    <div className="w-64 h-screen bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col flex-shrink-0 sticky top-0 transition-colors duration-300">
      <div className="p-6">
